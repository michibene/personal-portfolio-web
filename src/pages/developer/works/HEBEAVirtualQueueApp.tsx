...
export default function HEBEAVirtualQueueApp() {
  return (
    <WorksDetailSection
      id={1}
      abstractParagraph="The hematology clinic's website as well as the virtual waiting room function. Patients can see the actual wait time for a doctor or nurse. The doctor and nurse have their own dashboard for patient management. Patients are automatically added to the waiting room based on their scheduled time."
    ...
    >
      <div className="h-[80vh] md:h-[70vh] flex flex-col justify-center">
        <p className="text-center bigger-thin">
          Patients can see the actual wait times - how long it takes to be seen by a doctor or
          nurse.
        </p>
      </div>
      ...
      <div className="h-[80vh] md:h-[70vh] flex flex-col justify-center">
        <p className="text-center bigger-thin">
          The doctor or nurse has their own dashboard as an overview of the current status or
          patient management
        </p>
      </div>
