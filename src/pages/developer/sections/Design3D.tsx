      ...
      <FadeInOpacity>
        <div className="mt-20 mb-32 md:mt-36 md:mb-40">
          <p className="text-left md:text-center">
            As a part of landscape architecture, we worked on 3D models of gardens and parks on a
            daily basis (see some visualizations in the #landscapeArchitect section). This has
            become my hobby. Later, I&apos;ve been actively learning the basics of animation in my
            spare time. Here is a short animation I&apos;ve made in Blender.
          </p>
        </div>
      </FadeInOpacity>

      <FadeInOpacity>
        <div className="w-full md:w-2/3 mx-auto  aspect-video">
          <iframe
