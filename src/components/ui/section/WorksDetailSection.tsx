    ...
    <>
      {portfolioItem ? (
        <div className="max-w-7xl mx-auto px-5">
          <div
            className="my-5 lg:mt-24 lg:mb-0 text-custom-black shadow-[0_-5px_80px_-15px_rgba(217,216,209,0.5)] shadow-stone-50/20 lg:shadow-stone-50/30"
          ...
          <div className="pt-20 pb-12 md:pt-24 md:pb-16 flex justify-center">
            <button className="w-8 md:w-12 hover:text-developer-blue" onClick={handleCloseButton}>
              <CloseButton />
            </button>
          </div>
