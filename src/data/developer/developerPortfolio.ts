export default [
  {
    ...
    techStack:
      "NodeJS, ExpressJS, JWT, Sequelize, PostgreSQL, React, TypeScript, Tailwind CSS, Jest",
  ...
  },
  {
    ...
    techStack:
      "NodeJS, ExpressJS, JWT, PostgreSQL, React, TypeScript, Bootstrap, Jest, AWS (EC2, NGNIX, PM2)",
    justifyTo: "justify-start",
    smallerSize: false,
